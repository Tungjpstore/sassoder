...
export const featureLabels: Record<PlanFeatureKey, string> = {
  ...
  inventory_basic: "Kho cơ bản",
  inventory_premium: "Trung tâm vận hành kho",
  inventory_procurement: "Mua hàng & nhập kho nâng cao",
  inventory_warehouse_advanced: "Kho nhiều chi nhánh & lô hàng",
  inventory_alerts: "Cảnh báo kho tự động",
  inventory_ai_ocr: "AI đọc hóa đơn nhập kho",
  inventory_ai_intelligence: "AI tối ưu tồn kho",
...
const fallbackCapabilities: Record<"pro" | "premium", Partial<Record<PlanFeatureKey, Omit<PlanFeatureState, "source">>>> = {
  pro: {
    ...
    inventory_basic: { enabled: true, limitValue: null },
    inventory_premium: { enabled: false, limitValue: null },
    inventory_procurement: { enabled: false, limitValue: null },
    inventory_warehouse_advanced: { enabled: false, limitValue: null },
    inventory_alerts: { enabled: false, limitValue: null },
    inventory_ai_ocr: { enabled: false, limitValue: null },
    inventory_ai_intelligence: { enabled: false, limitValue: null },
  ...
  premium: {
    ...
    inventory_management: { enabled: true, limitValue: null },
    inventory_basic: { enabled: true, limitValue: null },
    inventory_premium: { enabled: true, limitValue: null },
    inventory_procurement: { enabled: true, limitValue: null },
    inventory_warehouse_advanced: { enabled: true, limitValue: null },
    inventory_alerts: { enabled: true, limitValue: null },
    inventory_ai_ocr: { enabled: true, limitValue: 300 },
    inventory_ai_intelligence: { enabled: true, limitValue: 120 },
...
export const legacyBillingFeatureMap: Partial<Record<PlanFeatureKey, BillingFeatureKey>> = {
  ...
  inventory_procurement: "inventory_premium",
  inventory_warehouse_advanced: "inventory_premium",
  inventory_alerts: "inventory_premium",
