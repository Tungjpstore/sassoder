...
test("promotion evaluator discounts configured free items without exceeding subtotal", () => {
  assert.deepEqual(
    evaluatePromotionDiscount({
      itemSubtotal: 30000,
      items: [
        { menuItemId: "tea", quantity: 2, unitPrice: 18000 },
        { menuItemId: "topping", quantity: 1, unitPrice: 12000 }
      ],
      rule: {
