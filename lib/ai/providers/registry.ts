  ...
  const definitions = [
    {
      ...
      reasoningModelEnvNames: ["MIMO_REASONING_MODEL"],
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["DEEPSEEK_REASONING_MODEL"],
      chatModel: "deepseek-chat",
      fastModel: "deepseek-chat",
      imageModel: "unsupported",
      ocrModel: "unsupported",
      reasoningModel: "deepseek-reasoning",
      supportsJsonMode: true,
      supportsToolCalling: true,
      supportsImageGeneration: false,
      supportsOcr: false,
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["QWEN_REASONING_MODEL"],
      chatModel: "qwen-plus",
      fastModel: "qwen-plus",
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["NVIDIA_REASONING_MODEL"],
      chatModel: "meta/llama-3.1-70b-instruct",
      fastModel: "meta/llama-3.1-8b-instruct",
      imageModel: "unsupported",
      ocrModel: "unsupported",
      reasoningModel: "meta/llama-3.1-70b-instruct",
      supportsJsonMode: true,
      supportsToolCalling: true,
      supportsImageGeneration: false,
      supportsOcr: false,
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["BEDROCK_REASONING_MODEL"],
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["OPENAI_REASONING_MODEL"],
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["GEMINI_REASONING_MODEL"],
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["CLAUDE_REASONING_MODEL"],
    ...
    },
    {
      ...
      reasoningModelEnvNames: ["VERCEL_AI_GATEWAY_REASONING_MODEL"],
...
function buildProviderConfig(definition: ProviderDefinition, override?: ManagedAiProviderRuntimeOverride | null): AiProviderConfig {
  ...
  return {
    ...
    reasoningModel: readEnv(definition.reasoningModelEnvNames) || definition.reasoningModel,
