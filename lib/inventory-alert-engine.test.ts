...
const staleIngredientId = "33333333-3333-4333-8333-333333333334";
const branchId = "44444444-4444-4444-8444-444444444444";
const stockBalanceId = "55555555-5555-4555-8555-555555555555";
const staleStockBalanceId = "55555555-5555-4555-8555-555555555556";
...
test("buildInventoryAlertCandidates produces P3 operational alert classes", () => {
  const candidates = buildInventoryAlertCandidates({
    ...
    stockBalances: [
      ...
      {
        id: staleStockBalanceId,
        branchId,
        locationId: "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaab",
        batchId: null,
        ingredientId: staleIngredientId,
        ingredientName: "Đào ngâm",
        ingredientUnit: "hộp",
        onHandQuantity: 12,
        reservedQuantity: 0,
        incomingQuantity: 0,
        minimumQuantity: 2,
        referenceUnitCost: 90000,
        countedAt: "2026-04-01T08:00:00.000Z",
  ...
  assert.ok(alertTypes.has("stale_stock"));
  ...
  const staleStock = candidates.find((candidate) => candidate.alertType === "stale_stock");
  assert.equal(staleStock?.sourceId, staleStockBalanceId);
});
