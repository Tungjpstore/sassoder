...
function ReservationFlowPreview({ depositRequired }: { depositRequired: boolean }) {
  return (
    <OrderFlowRail
      ...
      stages={[
        {
          ...
          title: "Chọn bàn",
          caption: "Chọn ngày, giờ và số khách phù hợp."
        },
        depositRequired
          ? {
              src: orderFlowImageSources.paymentVietqr,
              title: "Cọc VietQR",
              caption: "Giữ bàn nhanh bằng mã chuyển khoản."
            }
          : {
              src: orderFlowImageSources.restaurantConfirmation,
              title: "Quán nhận lịch",
              caption: "Không cần cọc, quán nhận thông tin ngay."
            },
        {
          src: orderFlowImageSources.paymentConfirmation,
          title: "Xác nhận",
          caption: "Quán duyệt lịch hoặc xác nhận cọc."
        },
        {
          src: orderFlowImageSources.completed,
          title: "Đến quán",
          caption: "Khách check-in đúng giờ đã đặt."
        }
      ]}
      eagerFirst
    />
