...
const markerPalette: Record<LogiVNMarkerTone, { className: string; style: string }> = {
  store: {
    className: "grid h-11 w-11 place-items-center rounded-2xl border border-white/80 shadow-[0_14px_30px_rgba(15,77,58,0.24)]",
    style: "background:#0F4D3A;color:white;"
  },
  branch: {
    className: "grid h-11 w-11 place-items-center rounded-2xl border border-white/80 shadow-[0_14px_30px_rgba(15,77,58,0.22)]",
  ...
  gps: {
    className: "grid h-11 w-11 place-items-center rounded-full border border-white/85 shadow-[0_16px_30px_rgba(15,77,58,0.22)]",
