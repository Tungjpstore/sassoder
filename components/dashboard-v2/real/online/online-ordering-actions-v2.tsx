...
export function OnlineOrderingActionsV2({
  onlineUrl,
  restaurantName,
  qrSrc
}: {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <ButtonLink href={onlineUrl} target="_blank" rel="noreferrer" size="sm" variant="secondary">
        <ExternalLink size={15} />
        Mở thử
      </ButtonLink>
      <ButtonLink href="/api/admin/online-qr?size=1200&download=1" size="sm" variant="ghost">
        <Download size={15} />
        Tải QR
      </ButtonLink>
