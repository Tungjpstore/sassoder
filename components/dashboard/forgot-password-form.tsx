...
export function ForgotPasswordForm() {
  ...
  return (
    ...
    >
      <Link href="/dashboard/login" className="mb-6 inline-flex items-center gap-2 text-sm font-bold text-[var(--primary-strong)] transition hover:text-[var(--primary)]">
      ...
      <div className="mb-7">
        ...
        <h1 className="text-2xl font-black tracking-tight sm:text-3xl">Đặt lại mật khẩu</h1>
