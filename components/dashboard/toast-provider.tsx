...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={value}>
      {children}
      <div className="fixed bottom-[calc(5.75rem+env(safe-area-inset-bottom))] right-4 z-[var(--z-dashboard-toast)] grid gap-2 max-lg:left-4 lg:bottom-[calc(1rem+env(safe-area-inset-bottom))] lg:w-[380px]">
        {toasts.map((t) => {
