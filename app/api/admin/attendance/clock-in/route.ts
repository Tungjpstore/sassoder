...
import { authorizeAttendanceManagementSession, clockInStaffAttendance } from "@/features/attendance/services/attendance-service";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await clockInStaffAttendance({ session: attendanceSession, input: { ...input, network: requestNetwork(request) } });
