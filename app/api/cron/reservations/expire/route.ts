    ...
    return ok(
      await runLoggedCron({
        ...
        summaryFromResult: (result) => ({
          ...
          notificationBatches: result.notifications.batches,
          notificationScanned: result.notifications.scanned,
          notificationSent: result.notifications.sent,
          notificationSkipped: result.notifications.skipped,
          notificationFailed: result.notifications.failed,
