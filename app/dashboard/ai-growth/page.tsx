...
export default async function AiGrowthPage() {
  ...
  return (
    <AdminShell
      ...
      subtitle="Trung tâm tăng doanh thu: campaign, combo, upsell và nội dung marketing theo tín hiệu vận hành"
    ...
    >
      <div className="dashboard-ai-workspace grid gap-3">
        <div className="dashboard-ai-toolbar flex flex-wrap items-center justify-between gap-2">
          ...
          <Link href="/api/admin/ai/growth" className="dashboard-secondary-action">
            API growth
            <ArrowRight size={15} />
          </Link>
        </div>
