...
export default async function AiMenuPage() {
  ...
  return (
    <AdminShell
      title="AI Menu Studio"
      restaurantName={session.restaurant.name}
      restaurantId={session.restaurantId}
      entitlement={entitlement}
      subtitle="Trung tâm tối ưu menu: ảnh món, combo, topping, seasonal, pricing guard và prompt publish an toàn"
    ...
    >
      <div className="dashboard-ai-workspace grid gap-3">
        <div className="dashboard-ai-toolbar flex flex-wrap items-center justify-between gap-2">
          ...
          <Link href="/api/admin/ai/menu-studio" className="dashboard-secondary-action">
            API menu
            <ArrowRight size={15} />
          </Link>
        </div>
