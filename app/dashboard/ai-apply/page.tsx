...
export default async function AiApplyPage() {
  ...
  return (
    <AdminShell
      ...
      subtitle="Preflight và kế hoạch áp dụng confirm-first cho menu, growth, support, workflow và recommendation"
    ...
    >
      <div className="grid gap-3">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <Link href="/api/admin/ai/apply-plans" className="dashboard-secondary-action">
            API apply
            <ArrowRight size={15} />
          </Link>
        </div>
        ...
        <section className="dashboard-panel p-4">
          ...
          {deck.plans.length ? (
            ...
            <div className="mt-3 grid min-h-24 place-items-center rounded-xl border border-dashed border-[var(--border)] px-4 text-center text-sm font-semibold text-[var(--muted-foreground)]">
              Chưa có plan apply. Duyệt item trong AI Execution Center để tạo đường apply rõ ràng.
            </div>
          )}
        </section>
