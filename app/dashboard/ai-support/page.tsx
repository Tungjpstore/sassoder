...
export default async function AiSupportPage() {
  ...
  return (
    <AdminShell
      ...
      subtitle="Trung tâm chuẩn bị chatbot hỗ trợ khách: FAQ, menu, đặt bàn, đơn hàng, thanh toán và handoff an toàn"
    ...
    >
      <div className="dashboard-ai-workspace grid gap-3">
        <div className="dashboard-ai-toolbar flex flex-wrap items-center justify-between gap-2">
          ...
          <Link href="/api/admin/ai/support" className="dashboard-secondary-action">
            API support
            <ArrowRight size={15} />
          </Link>
        </div>
