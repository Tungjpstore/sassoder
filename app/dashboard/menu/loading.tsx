      ...
      <section className="mx-auto grid w-full max-w-[1500px] gap-3">
        ...
        <section className="dashboard-panel p-4">
          ...
          <div className="mt-4 overflow-hidden rounded-xl border border-[var(--border)]">
            {[0, 1, 2, 3, 4].map((item) => (
              <div key={item} className="grid grid-cols-[64px_1fr_120px] gap-3 border-b border-[var(--border)] px-4 py-3 last:border-b-0">
                <div className="h-12 w-12 rounded-lg bg-[var(--soft-surface)]" />
                <div>
                  <div className="h-5 w-44 rounded-full bg-[var(--soft-surface)]" />
                  <div className="mt-2 h-4 w-28 rounded-full bg-[var(--soft-surface)]" />
                </div>
                <div className="h-8 rounded-lg bg-[var(--soft-surface)]" />
              </div>
            ))}
          </div>
        </section>
