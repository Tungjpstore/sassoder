    ...
    <main className="stitch-admin admin-shell-bg dashboard-density min-h-screen px-3 py-4 text-[var(--foreground)] md:px-6 lg:pl-80">
      <section className="mx-auto grid min-h-[72vh] w-full max-w-[900px] place-items-center">
        <div className="dashboard-panel w-full p-5 text-center">
          ...
          <h1 className="mt-3 text-2xl font-black text-[var(--foreground)]">Không tải được Menu món</h1>
          <p className="mx-auto mt-1 max-w-xl text-sm font-semibold leading-6 text-[var(--muted-foreground)]">
            Danh mục hoặc món đang bị gián đoạn. Tải lại trước khi chỉnh giá, bật/tắt món hoặc nhập menu bằng AI.
          </p>
          ...
          <div className="mt-4 flex flex-col justify-center gap-2 sm:flex-row">
            ...
            <Link href="/dashboard/tables" className="inline-flex h-10 items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 text-sm font-black text-[var(--primary-strong)]">
              Mở Bàn & QR
            </Link>
          </div>
        </div>
