    ...
    <main className="stitch-admin admin-shell-bg dashboard-density dashboard-route-fallback">
      <section className="mx-auto grid min-h-[72vh] w-full max-w-[900px] place-items-center">
        <div className="dashboard-panel w-full p-5 text-center">
          ...
          <h1 className="dashboard-page-title mt-3">Không tải được Đơn hàng realtime</h1>
          ...
          <div className="mt-4 flex flex-col justify-center gap-2 sm:flex-row">
            ...
            <Link href="/dashboard/kitchen" className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 text-sm font-semibold text-[var(--primary-strong)]">
              Mở bếp
            </Link>
          </div>
        </div>
